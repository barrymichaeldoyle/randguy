...
export const metadata: Metadata = {
  ...
  description:
    'South African personal finance and investing guides. Free calculators, tax tools, and insights on TFSAs, ETFs, interest rates, and building wealth in SA.',
  alternates: {
    canonical: '/',
    languages: {
      'en-ZA': '/',
  ...
  openGraph: {
    title: 'Rand Guy | South African Personal Finance & Investment Guide',
    description:
      'South African personal finance and investing guides. Free calculators and insights on TFSAs, ETFs, interest rates, and building wealth.',
    type: 'website',
    url: '/',
    siteName: 'Rand Guy',
    locale: 'en_ZA',
      ...
      >
        <div className="mb-12 text-center">
          ...
          <h1 className={`${excali.className} mb-2 text-4xl`}>
            South African Personal Finance & Investment Guide
          </h1>
          <p className="mb-6 text-lg text-gray-700">{TAGLINE}</p>
        </div>
      </div>
