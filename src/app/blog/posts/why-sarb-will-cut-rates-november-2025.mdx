export const metadata = {
  ...
  video: {
    url: 'https://youtube.com/shorts/0I1F3Y_pzaM',
    title: 'Why SARB Will Cut Rates in November 2025 - YouTube Short',
    thumbnail: 'https://img.youtube.com/vi/0I1F3Y_pzaM/maxresdefault.jpg',
  },
};

The South African Reserve Bank (SARB) is set to announce its interest rate decision on **Thursday, 20 November 2025**. Based on the latest inflation data and SARB policy trends, I'm predicting a rate cut - and here's why the data supports this.

> **🎥 Prefer the quick version?** Watch the [YouTube Short breakdown](https://youtube.com/shorts/0I1F3Y_pzaM) for the headline numbers and key takeaways in under a minute. This post digs deeper into the data behind that view.

<YouTubeEmbed
  videoId="https://youtube.com/shorts/0I1F3Y_pzaM"
  title="Why SARB Will Cut Rates in November 2025 - YouTube Short"
  isShort
/>
...
> **Note:** October's CPI data will be released on Wednesday, 19 November 2025 (before the SARB announcement on 20 November). While the official data isn't available yet, most economic forecasts are predicting October inflation will match September's 3.4% rate, suggesting continued stability.
...
- **R500,000 bond:** ~R100/month savings
- **R1 million bond:** ~R210/month savings
- **R2 million bond:** ~R420/month savings
- **R3 million bond:** ~R630/month savings
- **R4 million bond:** ~R840/month savings
- **R5 million bond:** ~R1,050/month savings
- **R10 million bond:** ~R2,100/month savings
...
While nothing is guaranteed, the probability of a rate cut is high. The SARB Monetary Policy Committee announces its decision on **Thursday, 20 November 2025, at approximately 15:30 SAST**.
