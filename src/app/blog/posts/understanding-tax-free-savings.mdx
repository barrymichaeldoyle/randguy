...
1. **[Easy Equities]({LINKS.easyEquities})** - Great for ETFs, low minimum (my most recommended)
...
3. **Open a TFSA this week** with [Easy Equities]({LINKS.easyEquities}) - Seriously, go do it now.
