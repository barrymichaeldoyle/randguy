...
export const metadata = {
  ...
  video: {
    url: 'https://youtube.com/shorts/3DiICqcHvbQ',
    title: 'Understanding Tax-Free Savings Accounts',
    thumbnail: 'https://img.youtube.com/vi/3DiICqcHvbQ/maxresdefault.jpg',
  },
};
...
> **🎥 Prefer the quick version?** I made a [YouTube Short about TFSAs](https://youtube.com/shorts/3DiICqcHvbQ) covering the key points in under a minute. This blog post expands on that with more detail and examples.

<YouTubeEmbed
  videoId="https://youtube.com/shorts/3DiICqcHvbQ"
  title="Understanding Tax-Free Savings Accounts - YouTube Short"
  isShort
/>
